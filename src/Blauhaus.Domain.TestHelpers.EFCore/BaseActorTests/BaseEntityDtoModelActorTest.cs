...
{
    public abstract class BaseDtoEntityActorTest<TDbContext, TActor, TModel, TEntity, TEntityBuilder, TDto> : BaseEntityActorTest<TDbContext, TActor, TModel, TEntity, TEntityBuilder> 
