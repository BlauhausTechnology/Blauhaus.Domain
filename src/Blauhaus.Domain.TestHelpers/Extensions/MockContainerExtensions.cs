...
namespace Blauhaus.Domain.TestHelpers.Extensions
{
    public static class MockContainerExtensions
    {
        ...
        //DtoCaches
        public static Func<SyncDtoCacheMockBuilder<TDto, TEntity, TId>> AddMockSyncDtoCache<TDto, TEntity, TId>(this MockContainer mocks) where TDto : class, IClientEntity<TId> where TEntity : class, ISyncClientEntity<TId> 
            => mocks.AddMock<SyncDtoCacheMockBuilder<TDto, TEntity, TId>, ISyncDtoCache<TDto, TEntity,TId>>();
